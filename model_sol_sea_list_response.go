...
// SolSeaListResponse struct for SolSeaListResponse
type SolSeaListResponse struct {
...
func (o SolSeaListResponse) MarshalJSON() ([]byte, error) {
...
type NullableSolSeaListResponse struct {
	value *SolSeaListResponse
	isSet bool
}

func (v NullableSolSeaListResponse) Get() *SolSeaListResponse {
	return v.value
}

func (v *NullableSolSeaListResponse) Set(val *SolSeaListResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableSolSeaListResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableSolSeaListResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSolSeaListResponse(val *SolSeaListResponse) *NullableSolSeaListResponse {
	return &NullableSolSeaListResponse{value: val, isSet: true}
}

func (v NullableSolSeaListResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSolSeaListResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
To add attributes to the NFT, add them to a JSON file and upload that to Arweave/IPFS/Filecoin. The JSON file should follow this format: <a href="https://docs.metaplex.com/nft-standard" target="_blank">NFT Standard.</a> (See the "URI JSON Schema" section in that article). Then supply the link to the JSON file in `nft_url`. You don't need to use `nft_metadata`.

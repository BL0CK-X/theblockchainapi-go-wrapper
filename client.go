...
// APIClient manages communication with the The Blockchain API API vnull
...
type APIClient struct {
	...
	CCPaymentApi *CCPaymentApiService

	CCProjectApi *CCProjectApiService

	CCWebhookApi *CCWebhookApiService

	NameServiceApi *NameServiceApiService

	SolanaAccountApi *SolanaAccountApiService

	SolanaCandyMachineApi *SolanaCandyMachineApiService
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	// API Services
	c.CCPaymentApi = (*CCPaymentApiService)(&c.common)
	c.CCProjectApi = (*CCProjectApiService)(&c.common)
	c.CCWebhookApi = (*CCWebhookApiService)(&c.common)
	c.NameServiceApi = (*NameServiceApiService)(&c.common)

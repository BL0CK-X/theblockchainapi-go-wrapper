...
// DelistRequest struct for DelistRequest
...
func (o DelistRequest) MarshalJSON() ([]byte, error) {
...
type NullableDelistRequest struct {
	value *DelistRequest
	isSet bool
}

func (v NullableDelistRequest) Get() *DelistRequest {
	return v.value
}

func (v *NullableDelistRequest) Set(val *DelistRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableDelistRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableDelistRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDelistRequest(val *DelistRequest) *NullableDelistRequest {
	return &NullableDelistRequest{value: val, isSet: true}
}

func (v NullableDelistRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDelistRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true

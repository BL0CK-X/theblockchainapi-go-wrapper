...
// GeneralPrivateKey struct for GeneralPrivateKey
type GeneralPrivateKey struct {
...
func (o GeneralPrivateKey) MarshalJSON() ([]byte, error) {
...
type NullableGeneralPrivateKey struct {
	value *GeneralPrivateKey
	isSet bool
}

func (v NullableGeneralPrivateKey) Get() *GeneralPrivateKey {
	return v.value
}

func (v *NullableGeneralPrivateKey) Set(val *GeneralPrivateKey) {
	v.value = val
	v.isSet = true
}

func (v NullableGeneralPrivateKey) IsSet() bool {
	return v.isSet
}

func (v *NullableGeneralPrivateKey) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGeneralPrivateKey(val *GeneralPrivateKey) *NullableGeneralPrivateKey {
	return &NullableGeneralPrivateKey{value: val, isSet: true}
}

func (v NullableGeneralPrivateKey) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGeneralPrivateKey) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// GetCandyDetailsErrorResponse struct for GetCandyDetailsErrorResponse
type GetCandyDetailsErrorResponse struct {
...
func NewGetCandyDetailsErrorResponse() *GetCandyDetailsErrorResponse {
	this := GetCandyDetailsErrorResponse{}
	return &this
}
...
func (o GetCandyDetailsErrorResponse) MarshalJSON() ([]byte, error) {
...
type NullableGetCandyDetailsErrorResponse struct {
	value *GetCandyDetailsErrorResponse
	isSet bool
}

func (v NullableGetCandyDetailsErrorResponse) Get() *GetCandyDetailsErrorResponse {
	return v.value
}

func (v *NullableGetCandyDetailsErrorResponse) Set(val *GetCandyDetailsErrorResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableGetCandyDetailsErrorResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableGetCandyDetailsErrorResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetCandyDetailsErrorResponse(val *GetCandyDetailsErrorResponse) *NullableGetCandyDetailsErrorResponse {
	return &NullableGetCandyDetailsErrorResponse{value: val, isSet: true}
}

func (v NullableGetCandyDetailsErrorResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetCandyDetailsErrorResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true

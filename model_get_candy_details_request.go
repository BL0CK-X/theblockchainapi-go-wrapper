...
// GetCandyDetailsRequest struct for GetCandyDetailsRequest
type GetCandyDetailsRequest struct {
...
func (o GetCandyDetailsRequest) MarshalJSON() ([]byte, error) {
...
type NullableGetCandyDetailsRequest struct {
	value *GetCandyDetailsRequest
	isSet bool
}

func (v NullableGetCandyDetailsRequest) Get() *GetCandyDetailsRequest {
	return v.value
}

func (v *NullableGetCandyDetailsRequest) Set(val *GetCandyDetailsRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableGetCandyDetailsRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableGetCandyDetailsRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetCandyDetailsRequest(val *GetCandyDetailsRequest) *NullableGetCandyDetailsRequest {
	return &NullableGetCandyDetailsRequest{value: val, isSet: true}
}

func (v NullableGetCandyDetailsRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetCandyDetailsRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true

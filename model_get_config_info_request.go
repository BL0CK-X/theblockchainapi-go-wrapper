...
// GetConfigInfoRequest struct for GetConfigInfoRequest
...
func (o GetConfigInfoRequest) MarshalJSON() ([]byte, error) {
...
type NullableGetConfigInfoRequest struct {
	value *GetConfigInfoRequest
	isSet bool
}

func (v NullableGetConfigInfoRequest) Get() *GetConfigInfoRequest {
	return v.value
}

func (v *NullableGetConfigInfoRequest) Set(val *GetConfigInfoRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableGetConfigInfoRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableGetConfigInfoRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetConfigInfoRequest(val *GetConfigInfoRequest) *NullableGetConfigInfoRequest {
	return &NullableGetConfigInfoRequest{value: val, isSet: true}
}

func (v NullableGetConfigInfoRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetConfigInfoRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true

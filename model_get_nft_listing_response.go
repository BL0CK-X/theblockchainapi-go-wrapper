...
// GetNFTListingResponse struct for GetNFTListingResponse
type GetNFTListingResponse struct {
...
func (o GetNFTListingResponse) MarshalJSON() ([]byte, error) {
...
type NullableGetNFTListingResponse struct {
	value *GetNFTListingResponse
	isSet bool
}

func (v NullableGetNFTListingResponse) Get() *GetNFTListingResponse {
	return v.value
}

func (v *NullableGetNFTListingResponse) Set(val *GetNFTListingResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableGetNFTListingResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableGetNFTListingResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetNFTListingResponse(val *GetNFTListingResponse) *NullableGetNFTListingResponse {
	return &NullableGetNFTListingResponse{value: val, isSet: true}
}

func (v NullableGetNFTListingResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetNFTListingResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true

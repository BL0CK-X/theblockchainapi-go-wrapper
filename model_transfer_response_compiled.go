...
// TransferResponseCompiled struct for TransferResponseCompiled
type TransferResponseCompiled struct {
...
type NullableTransferResponseCompiled struct {
	value *TransferResponseCompiled
	isSet bool
}

func (v NullableTransferResponseCompiled) Get() *TransferResponseCompiled {
	return v.value
}

func (v *NullableTransferResponseCompiled) Set(val *TransferResponseCompiled) {
	v.value = val
	v.isSet = true
}

func (v NullableTransferResponseCompiled) IsSet() bool {
	return v.isSet
}

func (v *NullableTransferResponseCompiled) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTransferResponseCompiled(val *TransferResponseCompiled) *NullableTransferResponseCompiled {
	return &NullableTransferResponseCompiled{value: val, isSet: true}
}

func (v NullableTransferResponseCompiled) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTransferResponseCompiled) UnmarshalJSON(src []byte) error {
	v.isSet = true

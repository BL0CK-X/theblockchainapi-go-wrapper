...
// GeneralSecretPhrase struct for GeneralSecretPhrase
type GeneralSecretPhrase struct {
...
// GetSecretRecoveryPhrase returns the SecretRecoveryPhrase field value if set, zero value otherwise.
func (o *GeneralSecretPhrase) GetSecretRecoveryPhrase() string {
	if o == nil || o.SecretRecoveryPhrase == nil {
		var ret string
		return ret
	}
...
// GetSecretRecoveryPhraseOk returns a tuple with the SecretRecoveryPhrase field value if set, nil otherwise
...
// SetSecretRecoveryPhrase gets a reference to the given string and assigns it to the SecretRecoveryPhrase field.
func (o *GeneralSecretPhrase) SetSecretRecoveryPhrase(v string) {
	o.SecretRecoveryPhrase = &v
}

func (o GeneralSecretPhrase) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}
	if o.SecretRecoveryPhrase != nil {
		toSerialize["secret_recovery_phrase"] = o.SecretRecoveryPhrase
	}
	return json.Marshal(toSerialize)
}

type NullableGeneralSecretPhrase struct {
	value *GeneralSecretPhrase
	isSet bool
}

func (v NullableGeneralSecretPhrase) Get() *GeneralSecretPhrase {
	return v.value
}

func (v *NullableGeneralSecretPhrase) Set(val *GeneralSecretPhrase) {
	v.value = val
	v.isSet = true
}

func (v NullableGeneralSecretPhrase) IsSet() bool {
	return v.isSet
}

func (v *NullableGeneralSecretPhrase) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGeneralSecretPhrase(val *GeneralSecretPhrase) *NullableGeneralSecretPhrase {
	return &NullableGeneralSecretPhrase{value: val, isSet: true}
}

func (v NullableGeneralSecretPhrase) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGeneralSecretPhrase) UnmarshalJSON(src []byte) error {
	v.isSet = true

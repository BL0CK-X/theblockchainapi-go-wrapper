...
func (r ApiGetTransactionRequest) Execute() (*GeneralTransaction, *http.Response, error) {
	return r.ApiService.GetTransactionExecute(r)
}

/*
GetTransaction Get the details of a transaction made on a blockchain

<a href="https://github.com/BL0CK-X/blockchain-api/tree/main/examples/transaction/get-transaction" target="_blank">See examples (Python, JavaScript)</a>.
...
*/
func (a *TransactionApiService) GetTransaction(ctx context.Context, blockchain string, network string, transactionBlockchainIdentifier string) ApiGetTransactionRequest {
	return ApiGetTransactionRequest{
		ApiService: a,
		ctx: ctx,
		blockchain: blockchain,
		network: network,
		transactionBlockchainIdentifier: transactionBlockchainIdentifier,
	}
}

// Execute executes the request
//  @return GeneralTransaction
func (a *TransactionApiService) GetTransactionExecute(r ApiGetTransactionRequest) (*GeneralTransaction, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *GeneralTransaction
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "TransactionApiService.GetTransaction")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/{blockchain}/transaction/{network}/{transaction_blockchain_identifier}"
	...
	localVarPath = strings.Replace(localVarPath, "{"+"transaction_blockchain_identifier"+"}", url.PathEscape(parameterToString(r.transactionBlockchainIdentifier, "")), -1)

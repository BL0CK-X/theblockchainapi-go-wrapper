...
// ProjectDeploymentURL struct for ProjectDeploymentURL
type ProjectDeploymentURL struct {
...
type NullableProjectDeploymentURL struct {
	value *ProjectDeploymentURL
	isSet bool
}

func (v NullableProjectDeploymentURL) Get() *ProjectDeploymentURL {
	return v.value
}

func (v *NullableProjectDeploymentURL) Set(val *ProjectDeploymentURL) {
	v.value = val
	v.isSet = true
}

func (v NullableProjectDeploymentURL) IsSet() bool {
	return v.isSet
}

func (v *NullableProjectDeploymentURL) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProjectDeploymentURL(val *ProjectDeploymentURL) *NullableProjectDeploymentURL {
	return &NullableProjectDeploymentURL{value: val, isSet: true}
}

func (v NullableProjectDeploymentURL) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProjectDeploymentURL) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// SolSeaBuyRequest struct for SolSeaBuyRequest
type SolSeaBuyRequest struct {
...
func (o SolSeaBuyRequest) MarshalJSON() ([]byte, error) {
...
type NullableSolSeaBuyRequest struct {
	value *SolSeaBuyRequest
	isSet bool
}

func (v NullableSolSeaBuyRequest) Get() *SolSeaBuyRequest {
	return v.value
}

func (v *NullableSolSeaBuyRequest) Set(val *SolSeaBuyRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableSolSeaBuyRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableSolSeaBuyRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSolSeaBuyRequest(val *SolSeaBuyRequest) *NullableSolSeaBuyRequest {
	return &NullableSolSeaBuyRequest{value: val, isSet: true}
}

func (v NullableSolSeaBuyRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSolSeaBuyRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true

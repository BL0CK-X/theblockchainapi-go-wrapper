...
// SolanaPublicKey struct for SolanaPublicKey
...
func (o SolanaPublicKey) MarshalJSON() ([]byte, error) {
...
type NullableSolanaPublicKey struct {
	value *SolanaPublicKey
	isSet bool
}

func (v NullableSolanaPublicKey) Get() *SolanaPublicKey {
	return v.value
}

func (v *NullableSolanaPublicKey) Set(val *SolanaPublicKey) {
	v.value = val
	v.isSet = true
}

func (v NullableSolanaPublicKey) IsSet() bool {
	return v.isSet
}

func (v *NullableSolanaPublicKey) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSolanaPublicKey(val *SolanaPublicKey) *NullableSolanaPublicKey {
	return &NullableSolanaPublicKey{value: val, isSet: true}
}

func (v NullableSolanaPublicKey) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSolanaPublicKey) UnmarshalJSON(src []byte) error {
	v.isSet = true

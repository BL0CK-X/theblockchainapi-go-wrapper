...
// GetCandyMachineIDRequest struct for GetCandyMachineIDRequest
type GetCandyMachineIDRequest struct {
...
func (o GetCandyMachineIDRequest) MarshalJSON() ([]byte, error) {
...
type NullableGetCandyMachineIDRequest struct {
	value *GetCandyMachineIDRequest
	isSet bool
}

func (v NullableGetCandyMachineIDRequest) Get() *GetCandyMachineIDRequest {
	return v.value
}

func (v *NullableGetCandyMachineIDRequest) Set(val *GetCandyMachineIDRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableGetCandyMachineIDRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableGetCandyMachineIDRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetCandyMachineIDRequest(val *GetCandyMachineIDRequest) *NullableGetCandyMachineIDRequest {
	return &NullableGetCandyMachineIDRequest{value: val, isSet: true}
}

func (v NullableGetCandyMachineIDRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetCandyMachineIDRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// AirdropRequest struct for AirdropRequest
...
func (o AirdropRequest) MarshalJSON() ([]byte, error) {
...
type NullableAirdropRequest struct {
	value *AirdropRequest
	isSet bool
}

func (v NullableAirdropRequest) Get() *AirdropRequest {
	return v.value
}

func (v *NullableAirdropRequest) Set(val *AirdropRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableAirdropRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableAirdropRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAirdropRequest(val *AirdropRequest) *NullableAirdropRequest {
	return &NullableAirdropRequest{value: val, isSet: true}
}

func (v NullableAirdropRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAirdropRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true

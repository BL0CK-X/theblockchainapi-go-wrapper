...
// GetAllNFTsResponseUnminted struct for GetAllNFTsResponseUnminted
type GetAllNFTsResponseUnminted struct {
...
func NewGetAllNFTsResponseUnminted() *GetAllNFTsResponseUnminted {
	this := GetAllNFTsResponseUnminted{}
	return &this
}
...
func (o GetAllNFTsResponseUnminted) MarshalJSON() ([]byte, error) {
...
type NullableGetAllNFTsResponseUnminted struct {
	value *GetAllNFTsResponseUnminted
	isSet bool
}

func (v NullableGetAllNFTsResponseUnminted) Get() *GetAllNFTsResponseUnminted {
	return v.value
}

func (v *NullableGetAllNFTsResponseUnminted) Set(val *GetAllNFTsResponseUnminted) {
	v.value = val
	v.isSet = true
}

func (v NullableGetAllNFTsResponseUnminted) IsSet() bool {
	return v.isSet
}

func (v *NullableGetAllNFTsResponseUnminted) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetAllNFTsResponseUnminted(val *GetAllNFTsResponseUnminted) *NullableGetAllNFTsResponseUnminted {
	return &NullableGetAllNFTsResponseUnminted{value: val, isSet: true}
}

func (v NullableGetAllNFTsResponseUnminted) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetAllNFTsResponseUnminted) UnmarshalJSON(src []byte) error {
	v.isSet = true

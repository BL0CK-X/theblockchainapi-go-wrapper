...
// MintNFTErrorResponse struct for MintNFTErrorResponse
type MintNFTErrorResponse struct {
...
func (o MintNFTErrorResponse) MarshalJSON() ([]byte, error) {
...
type NullableMintNFTErrorResponse struct {
	value *MintNFTErrorResponse
	isSet bool
}

func (v NullableMintNFTErrorResponse) Get() *MintNFTErrorResponse {
	return v.value
}

func (v *NullableMintNFTErrorResponse) Set(val *MintNFTErrorResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableMintNFTErrorResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableMintNFTErrorResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMintNFTErrorResponse(val *MintNFTErrorResponse) *NullableMintNFTErrorResponse {
	return &NullableMintNFTErrorResponse{value: val, isSet: true}
}

func (v NullableMintNFTErrorResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMintNFTErrorResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true

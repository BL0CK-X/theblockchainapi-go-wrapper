...
// ATARequest struct for ATARequest
...
func (o ATARequest) MarshalJSON() ([]byte, error) {
...
type NullableATARequest struct {
	value *ATARequest
	isSet bool
}

func (v NullableATARequest) Get() *ATARequest {
	return v.value
}

func (v *NullableATARequest) Set(val *ATARequest) {
	v.value = val
	v.isSet = true
}

func (v NullableATARequest) IsSet() bool {
	return v.isSet
}

func (v *NullableATARequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableATARequest(val *ATARequest) *NullableATARequest {
	return &NullableATARequest{value: val, isSet: true}
}

func (v NullableATARequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableATARequest) UnmarshalJSON(src []byte) error {
	v.isSet = true

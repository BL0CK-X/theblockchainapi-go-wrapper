...
// NFTOwnerResponse struct for NFTOwnerResponse
...
func (o NFTOwnerResponse) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}
	if true {
		toSerialize["nft_owner"] = o.NftOwner
	}
	return json.Marshal(toSerialize)
}

type NullableNFTOwnerResponse struct {
	value *NFTOwnerResponse
	isSet bool
}

func (v NullableNFTOwnerResponse) Get() *NFTOwnerResponse {
	return v.value
}

func (v *NullableNFTOwnerResponse) Set(val *NFTOwnerResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableNFTOwnerResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableNFTOwnerResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNFTOwnerResponse(val *NFTOwnerResponse) *NullableNFTOwnerResponse {
	return &NullableNFTOwnerResponse{value: val, isSet: true}
}

func (v NullableNFTOwnerResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNFTOwnerResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true

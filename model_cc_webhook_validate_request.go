...
// CCWebhookValidateRequest struct for CCWebhookValidateRequest
type CCWebhookValidateRequest struct {
	...
	WebhookSignature map[string]interface{} `json:"webhook_signature"`
	// The time the webhook was sent. 
	TimeSent float32 `json:"time_sent"`
}
...
// GetWebhookSignature returns the WebhookSignature field value
...
// GetWebhookSignatureOk returns a tuple with the WebhookSignature field value
// and a boolean to check if the value has been set.
func (o *CCWebhookValidateRequest) GetWebhookSignatureOk() (map[string]interface{}, bool) {
	if o == nil  {
		return nil, false
	}
	return o.WebhookSignature, true
}

// SetWebhookSignature sets field value
func (o *CCWebhookValidateRequest) SetWebhookSignature(v map[string]interface{}) {
	o.WebhookSignature = v
}

// GetTimeSent returns the TimeSent field value
...
// GetTimeSentOk returns a tuple with the TimeSent field value
// and a boolean to check if the value has been set.
...
// SetTimeSent sets field value
func (o *CCWebhookValidateRequest) SetTimeSent(v float32) {
	o.TimeSent = v
}

func (o CCWebhookValidateRequest) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}
	if true {
		toSerialize["webhook_id"] = o.WebhookId
	}
	if true {
		toSerialize["webhook_signature"] = o.WebhookSignature
	}
	if true {
...
type NullableCCWebhookValidateRequest struct {
	value *CCWebhookValidateRequest
	isSet bool
}

func (v NullableCCWebhookValidateRequest) Get() *CCWebhookValidateRequest {
	return v.value
}

func (v *NullableCCWebhookValidateRequest) Set(val *CCWebhookValidateRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableCCWebhookValidateRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableCCWebhookValidateRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCCWebhookValidateRequest(val *CCWebhookValidateRequest) *NullableCCWebhookValidateRequest {
	return &NullableCCWebhookValidateRequest{value: val, isSet: true}
}

func (v NullableCCWebhookValidateRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCCWebhookValidateRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true

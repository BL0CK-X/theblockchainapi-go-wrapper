...
// ParameterSpecification struct for ParameterSpecification
...
func (o ParameterSpecification) MarshalJSON() ([]byte, error) {
...
type NullableParameterSpecification struct {
	value *ParameterSpecification
	isSet bool
}

func (v NullableParameterSpecification) Get() *ParameterSpecification {
	return v.value
}

func (v *NullableParameterSpecification) Set(val *ParameterSpecification) {
	v.value = val
	v.isSet = true
}

func (v NullableParameterSpecification) IsSet() bool {
	return v.isSet
}

func (v *NullableParameterSpecification) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableParameterSpecification(val *ParameterSpecification) *NullableParameterSpecification {
	return &NullableParameterSpecification{value: val, isSet: true}
}

func (v NullableParameterSpecification) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableParameterSpecification) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// CCPaymentBlockchainPaymentDetails The information necessary to verify the payment.  
type CCPaymentBlockchainPaymentDetails struct {
...
func NewCCPaymentBlockchainPaymentDetails() *CCPaymentBlockchainPaymentDetails {
	this := CCPaymentBlockchainPaymentDetails{}
	return &this
}
...
// SetTotalPaid gets a reference to the given string and assigns it to the TotalPaid field.
...
func (o CCPaymentBlockchainPaymentDetails) MarshalJSON() ([]byte, error) {
...
type NullableCCPaymentBlockchainPaymentDetails struct {
	value *CCPaymentBlockchainPaymentDetails
	isSet bool
}

func (v NullableCCPaymentBlockchainPaymentDetails) Get() *CCPaymentBlockchainPaymentDetails {
	return v.value
}

func (v *NullableCCPaymentBlockchainPaymentDetails) Set(val *CCPaymentBlockchainPaymentDetails) {
	v.value = val
	v.isSet = true
}

func (v NullableCCPaymentBlockchainPaymentDetails) IsSet() bool {
	return v.isSet
}

func (v *NullableCCPaymentBlockchainPaymentDetails) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCCPaymentBlockchainPaymentDetails(val *CCPaymentBlockchainPaymentDetails) *NullableCCPaymentBlockchainPaymentDetails {
	return &NullableCCPaymentBlockchainPaymentDetails{value: val, isSet: true}
}

func (v NullableCCPaymentBlockchainPaymentDetails) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCCPaymentBlockchainPaymentDetails) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// NFTMintErrorResponse struct for NFTMintErrorResponse
type NFTMintErrorResponse struct {
...
func (o NFTMintErrorResponse) MarshalJSON() ([]byte, error) {
...
type NullableNFTMintErrorResponse struct {
	value *NFTMintErrorResponse
	isSet bool
}

func (v NullableNFTMintErrorResponse) Get() *NFTMintErrorResponse {
	return v.value
}

func (v *NullableNFTMintErrorResponse) Set(val *NFTMintErrorResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableNFTMintErrorResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableNFTMintErrorResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNFTMintErrorResponse(val *NFTMintErrorResponse) *NullableNFTMintErrorResponse {
	return &NullableNFTMintErrorResponse{value: val, isSet: true}
}

func (v NullableNFTMintErrorResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNFTMintErrorResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// GetAllNFTsResponseMinted struct for GetAllNFTsResponseMinted
type GetAllNFTsResponseMinted struct {
...
func (o GetAllNFTsResponseMinted) MarshalJSON() ([]byte, error) {
...
type NullableGetAllNFTsResponseMinted struct {
	value *GetAllNFTsResponseMinted
	isSet bool
}

func (v NullableGetAllNFTsResponseMinted) Get() *GetAllNFTsResponseMinted {
	return v.value
}

func (v *NullableGetAllNFTsResponseMinted) Set(val *GetAllNFTsResponseMinted) {
	v.value = val
	v.isSet = true
}

func (v NullableGetAllNFTsResponseMinted) IsSet() bool {
	return v.isSet
}

func (v *NullableGetAllNFTsResponseMinted) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetAllNFTsResponseMinted(val *GetAllNFTsResponseMinted) *NullableGetAllNFTsResponseMinted {
	return &NullableGetAllNFTsResponseMinted{value: val, isSet: true}
}

func (v NullableGetAllNFTsResponseMinted) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetAllNFTsResponseMinted) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// SolSeaDelistRequest struct for SolSeaDelistRequest
type SolSeaDelistRequest struct {
...
func (o SolSeaDelistRequest) MarshalJSON() ([]byte, error) {
...
type NullableSolSeaDelistRequest struct {
	value *SolSeaDelistRequest
	isSet bool
}

func (v NullableSolSeaDelistRequest) Get() *SolSeaDelistRequest {
	return v.value
}

func (v *NullableSolSeaDelistRequest) Set(val *SolSeaDelistRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableSolSeaDelistRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableSolSeaDelistRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSolSeaDelistRequest(val *SolSeaDelistRequest) *NullableSolSeaDelistRequest {
	return &NullableSolSeaDelistRequest{value: val, isSet: true}
}

func (v NullableSolSeaDelistRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSolSeaDelistRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// NFTOwnerAdvancedResponseContract The contract the NFT interacted with most recently. If there is none, this is null. 
type NFTOwnerAdvancedResponseContract struct {
	...
	ContractBlockchainIdentifier *string `json:"contract_blockchain_identifier,omitempty"`
...
func NewNFTOwnerAdvancedResponseContract() *NFTOwnerAdvancedResponseContract {
	this := NFTOwnerAdvancedResponseContract{}
	return &this
}
...
// GetContractBlockchainIdentifier returns the ContractBlockchainIdentifier field value if set, zero value otherwise.
func (o *NFTOwnerAdvancedResponseContract) GetContractBlockchainIdentifier() string {
	if o == nil || o.ContractBlockchainIdentifier == nil {
		var ret string
		return ret
	}
	return *o.ContractBlockchainIdentifier
}

// GetContractBlockchainIdentifierOk returns a tuple with the ContractBlockchainIdentifier field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *NFTOwnerAdvancedResponseContract) GetContractBlockchainIdentifierOk() (*string, bool) {
	if o == nil || o.ContractBlockchainIdentifier == nil {
		return nil, false
	}
	return o.ContractBlockchainIdentifier, true
}
...
// SetContractBlockchainIdentifier gets a reference to the given string and assigns it to the ContractBlockchainIdentifier field.
func (o *NFTOwnerAdvancedResponseContract) SetContractBlockchainIdentifier(v string) {
	o.ContractBlockchainIdentifier = &v
}
...
func (o NFTOwnerAdvancedResponseContract) MarshalJSON() ([]byte, error) {
	...
	if o.ContractBlockchainIdentifier != nil {
		toSerialize["contract_blockchain_identifier"] = o.ContractBlockchainIdentifier
	}
...
type NullableNFTOwnerAdvancedResponseContract struct {
	value *NFTOwnerAdvancedResponseContract
	isSet bool
}

func (v NullableNFTOwnerAdvancedResponseContract) Get() *NFTOwnerAdvancedResponseContract {
	return v.value
}

func (v *NullableNFTOwnerAdvancedResponseContract) Set(val *NFTOwnerAdvancedResponseContract) {
	v.value = val
	v.isSet = true
}

func (v NullableNFTOwnerAdvancedResponseContract) IsSet() bool {
	return v.isSet
}

func (v *NullableNFTOwnerAdvancedResponseContract) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNFTOwnerAdvancedResponseContract(val *NFTOwnerAdvancedResponseContract) *NullableNFTOwnerAdvancedResponseContract {
	return &NullableNFTOwnerAdvancedResponseContract{value: val, isSet: true}
}

func (v NullableNFTOwnerAdvancedResponseContract) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNFTOwnerAdvancedResponseContract) UnmarshalJSON(src []byte) error {
	v.isSet = true

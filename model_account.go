...
// SetContext gets a reference to the given AccountContext and assigns it to the Context field.
...
// SetValue gets a reference to the given AccountValue and assigns it to the Value field.

...
// AvalancheXPChainPublicAddress struct for AvalancheXPChainPublicAddress
type AvalancheXPChainPublicAddress struct {
	...
	BechPublicAddress *string `json:"bech_public_address,omitempty"`
...
func NewAvalancheXPChainPublicAddress() *AvalancheXPChainPublicAddress {
	this := AvalancheXPChainPublicAddress{}
	return &this
}
...
// GetBechPublicAddress returns the BechPublicAddress field value if set, zero value otherwise.
func (o *AvalancheXPChainPublicAddress) GetBechPublicAddress() string {
	if o == nil || o.BechPublicAddress == nil {
		var ret string
		return ret
	}
	return *o.BechPublicAddress
}

// GetBechPublicAddressOk returns a tuple with the BechPublicAddress field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AvalancheXPChainPublicAddress) GetBechPublicAddressOk() (*string, bool) {
	if o == nil || o.BechPublicAddress == nil {
		return nil, false
	}
	return o.BechPublicAddress, true
}
...
// SetBechPublicAddress gets a reference to the given string and assigns it to the BechPublicAddress field.
func (o *AvalancheXPChainPublicAddress) SetBechPublicAddress(v string) {
	o.BechPublicAddress = &v
}
...
func (o AvalancheXPChainPublicAddress) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}
	if o.BechPublicAddress != nil {
		toSerialize["bech_public_address"] = o.BechPublicAddress
	}
...
type NullableAvalancheXPChainPublicAddress struct {
	value *AvalancheXPChainPublicAddress
	isSet bool
}

func (v NullableAvalancheXPChainPublicAddress) Get() *AvalancheXPChainPublicAddress {
	return v.value
}

func (v *NullableAvalancheXPChainPublicAddress) Set(val *AvalancheXPChainPublicAddress) {
	v.value = val
	v.isSet = true
}

func (v NullableAvalancheXPChainPublicAddress) IsSet() bool {
	return v.isSet
}

func (v *NullableAvalancheXPChainPublicAddress) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAvalancheXPChainPublicAddress(val *AvalancheXPChainPublicAddress) *NullableAvalancheXPChainPublicAddress {
	return &NullableAvalancheXPChainPublicAddress{value: val, isSet: true}
}

func (v NullableAvalancheXPChainPublicAddress) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAvalancheXPChainPublicAddress) UnmarshalJSON(src []byte) error {
	v.isSet = true

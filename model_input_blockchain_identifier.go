...
// InputBlockchainIdentifier struct for InputBlockchainIdentifier
type InputBlockchainIdentifier struct {
...
func NewInputBlockchainIdentifier() *InputBlockchainIdentifier {
	this := InputBlockchainIdentifier{}
	return &this
}
...
func (o InputBlockchainIdentifier) MarshalJSON() ([]byte, error) {
...
type NullableInputBlockchainIdentifier struct {
	value *InputBlockchainIdentifier
	isSet bool
}

func (v NullableInputBlockchainIdentifier) Get() *InputBlockchainIdentifier {
	return v.value
}

func (v *NullableInputBlockchainIdentifier) Set(val *InputBlockchainIdentifier) {
	v.value = val
	v.isSet = true
}

func (v NullableInputBlockchainIdentifier) IsSet() bool {
	return v.isSet
}

func (v *NullableInputBlockchainIdentifier) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInputBlockchainIdentifier(val *InputBlockchainIdentifier) *NullableInputBlockchainIdentifier {
	return &NullableInputBlockchainIdentifier{value: val, isSet: true}
}

func (v NullableInputBlockchainIdentifier) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInputBlockchainIdentifier) UnmarshalJSON(src []byte) error {
	v.isSet = true

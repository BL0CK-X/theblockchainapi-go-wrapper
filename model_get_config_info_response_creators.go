...
// GetConfigInfoResponseCreators struct for GetConfigInfoResponseCreators
type GetConfigInfoResponseCreators struct {
...
func NewGetConfigInfoResponseCreators() *GetConfigInfoResponseCreators {
	this := GetConfigInfoResponseCreators{}
	return &this
}
...
func (o GetConfigInfoResponseCreators) MarshalJSON() ([]byte, error) {
...
type NullableGetConfigInfoResponseCreators struct {
	value *GetConfigInfoResponseCreators
	isSet bool
}

func (v NullableGetConfigInfoResponseCreators) Get() *GetConfigInfoResponseCreators {
	return v.value
}

func (v *NullableGetConfigInfoResponseCreators) Set(val *GetConfigInfoResponseCreators) {
	v.value = val
	v.isSet = true
}

func (v NullableGetConfigInfoResponseCreators) IsSet() bool {
	return v.isSet
}

func (v *NullableGetConfigInfoResponseCreators) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetConfigInfoResponseCreators(val *GetConfigInfoResponseCreators) *NullableGetConfigInfoResponseCreators {
	return &NullableGetConfigInfoResponseCreators{value: val, isSet: true}
}

func (v NullableGetConfigInfoResponseCreators) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetConfigInfoResponseCreators) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// SolanaTransactionMadeResponse struct for SolanaTransactionMadeResponse
type SolanaTransactionMadeResponse struct {
...
func NewSolanaTransactionMadeResponse() *SolanaTransactionMadeResponse {
	this := SolanaTransactionMadeResponse{}
	return &this
}
...
func (o SolanaTransactionMadeResponse) MarshalJSON() ([]byte, error) {
...
type NullableSolanaTransactionMadeResponse struct {
	value *SolanaTransactionMadeResponse
	isSet bool
}

func (v NullableSolanaTransactionMadeResponse) Get() *SolanaTransactionMadeResponse {
	return v.value
}

func (v *NullableSolanaTransactionMadeResponse) Set(val *SolanaTransactionMadeResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableSolanaTransactionMadeResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableSolanaTransactionMadeResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSolanaTransactionMadeResponse(val *SolanaTransactionMadeResponse) *NullableSolanaTransactionMadeResponse {
	return &NullableSolanaTransactionMadeResponse{value: val, isSet: true}
}

func (v NullableSolanaTransactionMadeResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSolanaTransactionMadeResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// CandyMachineSearchResponse struct for CandyMachineSearchResponse
type CandyMachineSearchResponse struct {
...
func NewCandyMachineSearchResponse(configAddress string) *CandyMachineSearchResponse {
	this := CandyMachineSearchResponse{}
...
func (o CandyMachineSearchResponse) MarshalJSON() ([]byte, error) {
...
type NullableCandyMachineSearchResponse struct {
	value *CandyMachineSearchResponse
	isSet bool
}

func (v NullableCandyMachineSearchResponse) Get() *CandyMachineSearchResponse {
	return v.value
}

func (v *NullableCandyMachineSearchResponse) Set(val *CandyMachineSearchResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableCandyMachineSearchResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableCandyMachineSearchResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCandyMachineSearchResponse(val *CandyMachineSearchResponse) *NullableCandyMachineSearchResponse {
	return &NullableCandyMachineSearchResponse{value: val, isSet: true}
}

func (v NullableCandyMachineSearchResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCandyMachineSearchResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true

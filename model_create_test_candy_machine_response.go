...
// CreateTestCandyMachineResponse struct for CreateTestCandyMachineResponse
type CreateTestCandyMachineResponse struct {
...
func NewCreateTestCandyMachineResponse(candyMachineId string) *CreateTestCandyMachineResponse {
	this := CreateTestCandyMachineResponse{}
...
// GetCandyMachineId returns the CandyMachineId field value
...
// GetCandyMachineIdOk returns a tuple with the CandyMachineId field value
...
// SetCandyMachineId sets field value
func (o *CreateTestCandyMachineResponse) SetCandyMachineId(v string) {
	o.CandyMachineId = v
}

func (o CreateTestCandyMachineResponse) MarshalJSON() ([]byte, error) {
...
type NullableCreateTestCandyMachineResponse struct {
	value *CreateTestCandyMachineResponse
	isSet bool
}

func (v NullableCreateTestCandyMachineResponse) Get() *CreateTestCandyMachineResponse {
	return v.value
}

func (v *NullableCreateTestCandyMachineResponse) Set(val *CreateTestCandyMachineResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateTestCandyMachineResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateTestCandyMachineResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateTestCandyMachineResponse(val *CreateTestCandyMachineResponse) *NullableCreateTestCandyMachineResponse {
	return &NullableCreateTestCandyMachineResponse{value: val, isSet: true}
}

func (v NullableCreateTestCandyMachineResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateTestCandyMachineResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true

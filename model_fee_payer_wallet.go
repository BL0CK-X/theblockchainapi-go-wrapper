...
func (dst *FeePayerWallet) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("Data matches more than one schema in oneOf(FeePayerWallet)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("Data failed to match schemas in oneOf(FeePayerWallet)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src FeePayerWallet) MarshalJSON() ([]byte, error) {
...
type NullableFeePayerWallet struct {
	value *FeePayerWallet
	isSet bool
}

func (v NullableFeePayerWallet) Get() *FeePayerWallet {
	return v.value
}

func (v *NullableFeePayerWallet) Set(val *FeePayerWallet) {
	v.value = val
	v.isSet = true
}

func (v NullableFeePayerWallet) IsSet() bool {
	return v.isSet
}

func (v *NullableFeePayerWallet) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFeePayerWallet(val *FeePayerWallet) *NullableFeePayerWallet {
	return &NullableFeePayerWallet{value: val, isSet: true}
}

func (v NullableFeePayerWallet) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFeePayerWallet) UnmarshalJSON(src []byte) error {
	v.isSet = true

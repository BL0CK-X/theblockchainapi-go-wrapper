...
// DelistResponse struct for DelistResponse
...
func (o DelistResponse) MarshalJSON() ([]byte, error) {
...
type NullableDelistResponse struct {
	value *DelistResponse
	isSet bool
}

func (v NullableDelistResponse) Get() *DelistResponse {
	return v.value
}

func (v *NullableDelistResponse) Set(val *DelistResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableDelistResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableDelistResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDelistResponse(val *DelistResponse) *NullableDelistResponse {
	return &NullableDelistResponse{value: val, isSet: true}
}

func (v NullableDelistResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDelistResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true

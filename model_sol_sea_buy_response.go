...
// SolSeaBuyResponse struct for SolSeaBuyResponse
type SolSeaBuyResponse struct {
...
func (o SolSeaBuyResponse) MarshalJSON() ([]byte, error) {
...
type NullableSolSeaBuyResponse struct {
	value *SolSeaBuyResponse
	isSet bool
}

func (v NullableSolSeaBuyResponse) Get() *SolSeaBuyResponse {
	return v.value
}

func (v *NullableSolSeaBuyResponse) Set(val *SolSeaBuyResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableSolSeaBuyResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableSolSeaBuyResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSolSeaBuyResponse(val *SolSeaBuyResponse) *NullableSolSeaBuyResponse {
	return &NullableSolSeaBuyResponse{value: val, isSet: true}
}

func (v NullableSolSeaBuyResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSolSeaBuyResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true

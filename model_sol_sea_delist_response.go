...
// SolSeaDelistResponse struct for SolSeaDelistResponse
type SolSeaDelistResponse struct {
...
func (o SolSeaDelistResponse) MarshalJSON() ([]byte, error) {
...
type NullableSolSeaDelistResponse struct {
	value *SolSeaDelistResponse
	isSet bool
}

func (v NullableSolSeaDelistResponse) Get() *SolSeaDelistResponse {
	return v.value
}

func (v *NullableSolSeaDelistResponse) Set(val *SolSeaDelistResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableSolSeaDelistResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableSolSeaDelistResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSolSeaDelistResponse(val *SolSeaDelistResponse) *NullableSolSeaDelistResponse {
	return &NullableSolSeaDelistResponse{value: val, isSet: true}
}

func (v NullableSolSeaDelistResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSolSeaDelistResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true

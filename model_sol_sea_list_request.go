...
// SolSeaListRequest struct for SolSeaListRequest
type SolSeaListRequest struct {
...
func (o SolSeaListRequest) MarshalJSON() ([]byte, error) {
...
type NullableSolSeaListRequest struct {
	value *SolSeaListRequest
	isSet bool
}

func (v NullableSolSeaListRequest) Get() *SolSeaListRequest {
	return v.value
}

func (v *NullableSolSeaListRequest) Set(val *SolSeaListRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableSolSeaListRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableSolSeaListRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSolSeaListRequest(val *SolSeaListRequest) *NullableSolSeaListRequest {
	return &NullableSolSeaListRequest{value: val, isSet: true}
}

func (v NullableSolSeaListRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSolSeaListRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true

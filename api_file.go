...
func (r ApiUploadFileRequest) Execute() (GetFileResponse, *_nethttp.Response, error) {
...
*/
func (a *FileApiService) UploadFile(ctx _context.Context) ApiUploadFileRequest {
	return ApiUploadFileRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *FileApiService) UploadFileExecute(r ApiUploadFileRequest) (GetFileResponse, *_nethttp.Response, error) {
	var (

...
// GetMintedNFTsRequest struct for GetMintedNFTsRequest
type GetMintedNFTsRequest struct {
...
func (o GetMintedNFTsRequest) MarshalJSON() ([]byte, error) {
...
type NullableGetMintedNFTsRequest struct {
	value *GetMintedNFTsRequest
	isSet bool
}

func (v NullableGetMintedNFTsRequest) Get() *GetMintedNFTsRequest {
	return v.value
}

func (v *NullableGetMintedNFTsRequest) Set(val *GetMintedNFTsRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableGetMintedNFTsRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableGetMintedNFTsRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetMintedNFTsRequest(val *GetMintedNFTsRequest) *NullableGetMintedNFTsRequest {
	return &NullableGetMintedNFTsRequest{value: val, isSet: true}
}

func (v NullableGetMintedNFTsRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetMintedNFTsRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
func NewNFTAnalyticsResponseTransactionHistory() *NFTAnalyticsResponseTransactionHistory {
	this := NFTAnalyticsResponseTransactionHistory{}
	return &this
}
...
type NullableNFTAnalyticsResponseTransactionHistory struct {
	value *NFTAnalyticsResponseTransactionHistory
	isSet bool
}

func (v NullableNFTAnalyticsResponseTransactionHistory) Get() *NFTAnalyticsResponseTransactionHistory {
	return v.value
}

func (v *NullableNFTAnalyticsResponseTransactionHistory) Set(val *NFTAnalyticsResponseTransactionHistory) {
	v.value = val
	v.isSet = true
}

func (v NullableNFTAnalyticsResponseTransactionHistory) IsSet() bool {
	return v.isSet
}

func (v *NullableNFTAnalyticsResponseTransactionHistory) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNFTAnalyticsResponseTransactionHistory(val *NFTAnalyticsResponseTransactionHistory) *NullableNFTAnalyticsResponseTransactionHistory {
	return &NullableNFTAnalyticsResponseTransactionHistory{value: val, isSet: true}
}

func (v NullableNFTAnalyticsResponseTransactionHistory) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNFTAnalyticsResponseTransactionHistory) UnmarshalJSON(src []byte) error {
	v.isSet = true

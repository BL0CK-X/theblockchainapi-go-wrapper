...
// BSCPublicAddress struct for BSCPublicAddress
type BSCPublicAddress struct {
...
func (o BSCPublicAddress) MarshalJSON() ([]byte, error) {
...
type NullableBSCPublicAddress struct {
	value *BSCPublicAddress
	isSet bool
}

func (v NullableBSCPublicAddress) Get() *BSCPublicAddress {
	return v.value
}

func (v *NullableBSCPublicAddress) Set(val *BSCPublicAddress) {
	v.value = val
	v.isSet = true
}

func (v NullableBSCPublicAddress) IsSet() bool {
	return v.isSet
}

func (v *NullableBSCPublicAddress) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBSCPublicAddress(val *BSCPublicAddress) *NullableBSCPublicAddress {
	return &NullableBSCPublicAddress{value: val, isSet: true}
}

func (v NullableBSCPublicAddress) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBSCPublicAddress) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// EthereumTransactionMadeResponse struct for EthereumTransactionMadeResponse
type EthereumTransactionMadeResponse struct {
	...
	TransactionConfirmed *bool `json:"transaction_confirmed,omitempty"`
}
...
func NewEthereumTransactionMadeResponse() *EthereumTransactionMadeResponse {
	this := EthereumTransactionMadeResponse{}
	return &this
}
...
// GetTransactionConfirmed returns the TransactionConfirmed field value if set, zero value otherwise.
func (o *EthereumTransactionMadeResponse) GetTransactionConfirmed() bool {
	if o == nil || o.TransactionConfirmed == nil {
		var ret bool
		return ret
	}
	return *o.TransactionConfirmed
}

// GetTransactionConfirmedOk returns a tuple with the TransactionConfirmed field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *EthereumTransactionMadeResponse) GetTransactionConfirmedOk() (*bool, bool) {
	if o == nil || o.TransactionConfirmed == nil {
		return nil, false
	}
	return o.TransactionConfirmed, true
}
...
// SetTransactionConfirmed gets a reference to the given bool and assigns it to the TransactionConfirmed field.
func (o *EthereumTransactionMadeResponse) SetTransactionConfirmed(v bool) {
	o.TransactionConfirmed = &v
}

func (o EthereumTransactionMadeResponse) MarshalJSON() ([]byte, error) {
	...
	if o.TransactionConfirmed != nil {
		toSerialize["transaction_confirmed"] = o.TransactionConfirmed
	}
	return json.Marshal(toSerialize)
}

type NullableEthereumTransactionMadeResponse struct {
	value *EthereumTransactionMadeResponse
	isSet bool
}

func (v NullableEthereumTransactionMadeResponse) Get() *EthereumTransactionMadeResponse {
	return v.value
}

func (v *NullableEthereumTransactionMadeResponse) Set(val *EthereumTransactionMadeResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableEthereumTransactionMadeResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableEthereumTransactionMadeResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEthereumTransactionMadeResponse(val *EthereumTransactionMadeResponse) *NullableEthereumTransactionMadeResponse {
	return &NullableEthereumTransactionMadeResponse{value: val, isSet: true}
}

func (v NullableEthereumTransactionMadeResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEthereumTransactionMadeResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true

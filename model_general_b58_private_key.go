...
// GeneralB58PrivateKey struct for GeneralB58PrivateKey
type GeneralB58PrivateKey struct {
	...
	B58PrivateKey string `json:"b58_private_key"`
}
...
// GetB58PrivateKey returns the B58PrivateKey field value
...
// GetB58PrivateKeyOk returns a tuple with the B58PrivateKey field value
...
// SetB58PrivateKey sets field value
func (o *GeneralB58PrivateKey) SetB58PrivateKey(v string) {
	o.B58PrivateKey = v
}

func (o GeneralB58PrivateKey) MarshalJSON() ([]byte, error) {
...
type NullableGeneralB58PrivateKey struct {
	value *GeneralB58PrivateKey
	isSet bool
}

func (v NullableGeneralB58PrivateKey) Get() *GeneralB58PrivateKey {
	return v.value
}

func (v *NullableGeneralB58PrivateKey) Set(val *GeneralB58PrivateKey) {
	v.value = val
	v.isSet = true
}

func (v NullableGeneralB58PrivateKey) IsSet() bool {
	return v.isSet
}

func (v *NullableGeneralB58PrivateKey) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGeneralB58PrivateKey(val *GeneralB58PrivateKey) *NullableGeneralB58PrivateKey {
	return &NullableGeneralB58PrivateKey{value: val, isSet: true}
}

func (v NullableGeneralB58PrivateKey) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGeneralB58PrivateKey) UnmarshalJSON(src []byte) error {
	v.isSet = true

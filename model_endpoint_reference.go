...
// EndpointReference struct for EndpointReference
...
func (o EndpointReference) MarshalJSON() ([]byte, error) {
...
type NullableEndpointReference struct {
	value *EndpointReference
	isSet bool
}

func (v NullableEndpointReference) Get() *EndpointReference {
	return v.value
}

func (v *NullableEndpointReference) Set(val *EndpointReference) {
	v.value = val
	v.isSet = true
}

func (v NullableEndpointReference) IsSet() bool {
	return v.isSet
}

func (v *NullableEndpointReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEndpointReference(val *EndpointReference) *NullableEndpointReference {
	return &NullableEndpointReference{value: val, isSet: true}
}

func (v NullableEndpointReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEndpointReference) UnmarshalJSON(src []byte) error {
	v.isSet = true

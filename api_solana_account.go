...
/*
SolanaGetAccount Get the details of an account on Solana

<a href="https://github.com/BL0CK-X/the-blockchain-api/tree/main/examples/solana-account/get-account" target="_blank">See examples (Python, JavaScript)</a>.
    
Get the details of an account on Solana. Learn more about accounts <a href="https://docs.solana.com/developing/programming-model/accounts" target="_blank">here</a>.
...
/*
SolanaGetAccountIsCandyMachine Get if account is candy machine

<a href="https://github.com/BL0CK-X/the-blockchain-api/tree/main/examples/solana-account/get-is-candy-machine" target="_blank">See examples (Python, JavaScript)</a>.
...
/*
SolanaGetAccountIsNFT Get if account is NFT

<a href="https://github.com/BL0CK-X/the-blockchain-api/tree/main/examples/solana-account/get-is-nft" target="_blank">See examples (Python, JavaScript)</a>.

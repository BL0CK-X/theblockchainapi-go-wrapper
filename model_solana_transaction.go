...
// SolanaTransaction struct for SolanaTransaction
...
func (o SolanaTransaction) MarshalJSON() ([]byte, error) {
...
type NullableSolanaTransaction struct {
	value *SolanaTransaction
	isSet bool
}

func (v NullableSolanaTransaction) Get() *SolanaTransaction {
	return v.value
}

func (v *NullableSolanaTransaction) Set(val *SolanaTransaction) {
	v.value = val
	v.isSet = true
}

func (v NullableSolanaTransaction) IsSet() bool {
	return v.isSet
}

func (v *NullableSolanaTransaction) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSolanaTransaction(val *SolanaTransaction) *NullableSolanaTransaction {
	return &NullableSolanaTransaction{value: val, isSet: true}
}

func (v NullableSolanaTransaction) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSolanaTransaction) UnmarshalJSON(src []byte) error {
	v.isSet = true

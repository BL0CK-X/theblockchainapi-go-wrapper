...
// ListTokensRequest struct for ListTokensRequest
type ListTokensRequest struct {
	// Whether or not to include NFTs in the response
	IncludeNfts *bool `json:"include_nfts,omitempty"`
	...
	IncludeZeroBalanceHoldings *bool `json:"include_zero_balance_holdings,omitempty"`
}
...
func NewListTokensRequest() *ListTokensRequest {
	this := ListTokensRequest{}
	var includeNfts bool = false
	this.IncludeNfts = &includeNfts
	var includeZeroBalanceHoldings bool = false
...
// GetIncludeNfts returns the IncludeNfts field value if set, zero value otherwise.
func (o *ListTokensRequest) GetIncludeNfts() bool {
	if o == nil || o.IncludeNfts == nil {
		var ret bool
		return ret
	}
	return *o.IncludeNfts
}

// GetIncludeNftsOk returns a tuple with the IncludeNfts field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ListTokensRequest) GetIncludeNftsOk() (*bool, bool) {
	if o == nil || o.IncludeNfts == nil {
		return nil, false
	}
	return o.IncludeNfts, true
}
...
// SetIncludeNfts gets a reference to the given bool and assigns it to the IncludeNfts field.
func (o *ListTokensRequest) SetIncludeNfts(v bool) {
	o.IncludeNfts = &v
}

// GetIncludeZeroBalanceHoldings returns the IncludeZeroBalanceHoldings field value if set, zero value otherwise.
func (o *ListTokensRequest) GetIncludeZeroBalanceHoldings() bool {
	if o == nil || o.IncludeZeroBalanceHoldings == nil {
		var ret bool
		return ret
	}
	return *o.IncludeZeroBalanceHoldings
}

// GetIncludeZeroBalanceHoldingsOk returns a tuple with the IncludeZeroBalanceHoldings field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ListTokensRequest) GetIncludeZeroBalanceHoldingsOk() (*bool, bool) {
	if o == nil || o.IncludeZeroBalanceHoldings == nil {
		return nil, false
	}
	return o.IncludeZeroBalanceHoldings, true
}
...
// SetIncludeZeroBalanceHoldings gets a reference to the given bool and assigns it to the IncludeZeroBalanceHoldings field.
func (o *ListTokensRequest) SetIncludeZeroBalanceHoldings(v bool) {
	o.IncludeZeroBalanceHoldings = &v
}

func (o ListTokensRequest) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}
	if o.IncludeNfts != nil {
		toSerialize["include_nfts"] = o.IncludeNfts
	}
	if o.IncludeZeroBalanceHoldings != nil {
		toSerialize["include_zero_balance_holdings"] = o.IncludeZeroBalanceHoldings
	}
	return json.Marshal(toSerialize)
}

type NullableListTokensRequest struct {
	value *ListTokensRequest
	isSet bool
}

func (v NullableListTokensRequest) Get() *ListTokensRequest {
	return v.value
}

func (v *NullableListTokensRequest) Set(val *ListTokensRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableListTokensRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableListTokensRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListTokensRequest(val *ListTokensRequest) *NullableListTokensRequest {
	return &NullableListTokensRequest{value: val, isSet: true}
}

func (v NullableListTokensRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListTokensRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true

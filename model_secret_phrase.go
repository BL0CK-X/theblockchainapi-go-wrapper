...
func (o SecretPhrase) MarshalJSON() ([]byte, error) {
...
type NullableSecretPhrase struct {
	value *SecretPhrase
	isSet bool
}

func (v NullableSecretPhrase) Get() *SecretPhrase {
	return v.value
}

func (v *NullableSecretPhrase) Set(val *SecretPhrase) {
	v.value = val
	v.isSet = true
}

func (v NullableSecretPhrase) IsSet() bool {
	return v.isSet
}

func (v *NullableSecretPhrase) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSecretPhrase(val *SecretPhrase) *NullableSecretPhrase {
	return &NullableSecretPhrase{value: val, isSet: true}
}

func (v NullableSecretPhrase) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSecretPhrase) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// CCProjectCreateRequest You can change any of these parameters after creating the project. None of these parameters are required. 
type CCProjectCreateRequest struct {
...
func (o CCProjectCreateRequest) MarshalJSON() ([]byte, error) {
...
type NullableCCProjectCreateRequest struct {
	value *CCProjectCreateRequest
	isSet bool
}

func (v NullableCCProjectCreateRequest) Get() *CCProjectCreateRequest {
	return v.value
}

func (v *NullableCCProjectCreateRequest) Set(val *CCProjectCreateRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableCCProjectCreateRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableCCProjectCreateRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCCProjectCreateRequest(val *CCProjectCreateRequest) *NullableCCProjectCreateRequest {
	return &NullableCCProjectCreateRequest{value: val, isSet: true}
}

func (v NullableCCProjectCreateRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCCProjectCreateRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true

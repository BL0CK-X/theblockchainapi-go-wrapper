...
type NullableGetPublicKeyRequest struct {
	value *GetPublicKeyRequest
	isSet bool
}

func (v NullableGetPublicKeyRequest) Get() *GetPublicKeyRequest {
	return v.value
}

func (v *NullableGetPublicKeyRequest) Set(val *GetPublicKeyRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableGetPublicKeyRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableGetPublicKeyRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetPublicKeyRequest(val *GetPublicKeyRequest) *NullableGetPublicKeyRequest {
	return &NullableGetPublicKeyRequest{value: val, isSet: true}
}

func (v NullableGetPublicKeyRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetPublicKeyRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true

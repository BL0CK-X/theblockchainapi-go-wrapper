...
// GeneralAirdropRequest struct for GeneralAirdropRequest
type GeneralAirdropRequest struct {
...
func (o GeneralAirdropRequest) MarshalJSON() ([]byte, error) {
...
type NullableGeneralAirdropRequest struct {
	value *GeneralAirdropRequest
	isSet bool
}

func (v NullableGeneralAirdropRequest) Get() *GeneralAirdropRequest {
	return v.value
}

func (v *NullableGeneralAirdropRequest) Set(val *GeneralAirdropRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableGeneralAirdropRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableGeneralAirdropRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGeneralAirdropRequest(val *GeneralAirdropRequest) *NullableGeneralAirdropRequest {
	return &NullableGeneralAirdropRequest{value: val, isSet: true}
}

func (v NullableGeneralAirdropRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGeneralAirdropRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true

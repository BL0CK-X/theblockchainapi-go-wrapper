...
// EthereumPublicAddress struct for EthereumPublicAddress
type EthereumPublicAddress struct {
...
func (o EthereumPublicAddress) MarshalJSON() ([]byte, error) {
...
type NullableEthereumPublicAddress struct {
	value *EthereumPublicAddress
	isSet bool
}

func (v NullableEthereumPublicAddress) Get() *EthereumPublicAddress {
	return v.value
}

func (v *NullableEthereumPublicAddress) Set(val *EthereumPublicAddress) {
	v.value = val
	v.isSet = true
}

func (v NullableEthereumPublicAddress) IsSet() bool {
	return v.isSet
}

func (v *NullableEthereumPublicAddress) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEthereumPublicAddress(val *EthereumPublicAddress) *NullableEthereumPublicAddress {
	return &NullableEthereumPublicAddress{value: val, isSet: true}
}

func (v NullableEthereumPublicAddress) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEthereumPublicAddress) UnmarshalJSON(src []byte) error {
	v.isSet = true
